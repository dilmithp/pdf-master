...
resource "aws_eks_cluster" "main" {
  ...
  vpc_config {
    ...
    endpoint_public_access  = true  # restrict to VPN IP in production via public_access_cidrs
    # public_access_cidrs   = ["YOUR_VPN_CIDR/32"]
  }
...
resource "aws_eks_node_group" "main" {
  ...
  ami_type        = "AL2023_ARM_64_STANDARD"  # Graviton3 (arm64 for m6g/m7g)
...
# --- aws-auth ConfigMap (add node group IAM role) ---
