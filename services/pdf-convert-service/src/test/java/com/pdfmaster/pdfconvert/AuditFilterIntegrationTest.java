...
import com.pdfmaster.pdfconvert.audit.SpringDataAuditLogRepository;
...
@SpringBootTest(properties = {
    ...
    "libreoffice.binary=/bin/true",
    "libreoffice.timeout-seconds=5"
})
@AutoConfigureMockMvc
@Testcontainers
class AuditFilterIntegrationTest {

  static final String BUCKET = "pdfmaster-audit-convert";
  ...
  void auditRowIsPersistedAfterRequest() throws Exception {
    ...
    mockMvc
        .perform(post("/v1/jobs/convert").contentType("application/json")
            .content("{\"from\":\"docx\",\"to\":\"pdf\"}").with(jwt()))
