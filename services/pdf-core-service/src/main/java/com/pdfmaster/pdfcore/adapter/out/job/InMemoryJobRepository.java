package com.pdfmaster.pdfcore.adapter.out.job;
...
/**
 * In-memory job store. Scaffolding-tier only — production moves to Redis or Postgres so that
 * horizontal worker replicas can share state.
 */
@Component
