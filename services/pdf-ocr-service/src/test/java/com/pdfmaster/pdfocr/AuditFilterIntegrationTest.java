...
import com.pdfmaster.pdfocr.audit.SpringDataAuditLogRepository;
...
class AuditFilterIntegrationTest {
  ...
  static final String BUCKET = "pdfmaster-audit-ocr";
  ...
  void auditRowIsPersistedAfterRequest() throws Exception {
    ...
    mockMvc
        .perform(post("/v1/jobs/ocr").contentType("application/json")
            .content("{\"language\":\"eng\"}").with(jwt()))
